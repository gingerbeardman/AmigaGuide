...
/// Checks the public GitHub Releases feed for a newer Amiga Guide version.
...
nonisolated enum UpdateChecker: Sendable {
    ...
    nonisolated static let latestReleaseURL = URL(
        string: "https://api.github.com/repos/gingerbeardman/AmigaGuide/releases/latest"
    )!
    ...
    nonisolated static func check() async throws -> CheckResult {
        ...
        request.setValue("AmigaGuide/\(currentVersion) (macOS)", forHTTPHeaderField: "User-Agent")
